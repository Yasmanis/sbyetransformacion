        ...
        <q-table :rows="rows" :columns="columns" :grid="$q.screen.lt.sm" :loading="loading"
            ...
            <template v-slot:top="props">
                <q-toolbar>
                    ...
                    <div class="col-auto">
                        ...
                        <refresh-component @refresh="onRequest" />
                        ...
                        <q-btn-component tooltips="limpiar todo" icon="mdi-eraser"
                            @click="router.get(current_module.base_url)"
                            v-if="pagination.filters || pagination.search || pagination.sortBy || pagination.page > 1" />
            ...
            <template v-slot:body-cell-actions="props">
                <q-td :props="props" :style="{
                    ...
                    <q-btn-component :tooltips="props.row.files.length === 0
                        ? ''
                        : 'ordenar ficheros'
                        " icon="mdi-sort" @click="onShowSort(props.row.files)" :disable="props.row.files.length < 2"
                        v-if="has_edit" />
...
import RefreshComponent from "../../table/actions/RefreshComponent.vue";
...
const onRefreshData = (prop, data) => {
    pagination.value[prop] = data !== undefined && data !== null ? JSON.stringify(data) : null;
