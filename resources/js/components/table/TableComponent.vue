                    ...
                    <div class="col-auto">
                        <form-component :title="current_module.singular_label" :fields="createFields"
                            :module="current_module" size="sm" v-if="
                                ...
                                has_add
                            " />
                        <form-file :title="current_module.singular_label" :module="current_module" size="sm"
                            @save="onRequest" v-if="current_module.model === 'File' && has_add" />
                        ...
                        <q-btn-component tooltips="limpiar todo" icon="mdi-eraser"
                            @click="router.get(current_module.base_url)" v-if="
                                pagination.filters ||
                                pagination.search ||
                                pagination.sortBy ||
                                pagination.page > 1
                ...
                <q-td :props="props" :align="props.col.align" v-if="props.col.type !== 'hidden'">
                    ...
                    <template v-else-if="props.col.type === 'boolean'">
                        <q-chip dense size="sm" style="max-width: min-content"
                            :color="props.value ? 'primary' : 'negative'" text-color="white"
...
import RefreshComponent from "./actions/RefreshComponent.vue";
