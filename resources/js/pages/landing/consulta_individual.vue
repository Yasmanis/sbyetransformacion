<template>
    <Layout>
                        ...
                        <div class="col-lg-6 col-md-6 pt-9">
                            ...
                            >
                                <div class="overview-title pb-4">
                                    <p
                                        class="text-center text-lowercase text-white header-subtitle"
                                    >
                ...
                <div class="inner-overview position-relative">
                    <div class="overview-left text-center">
                        <div class="overview-title pb-4">
                            ...
                            <p>
                                por tanto, solo atendere a personas que
                                realmente quieran cambiar y se involucren en su
                                cambio <br />
                                si estas preparado en profundizar en tu dolor,
                                sanarlo y transmutarlo, este es tu sitio <br />
                                puedes hacer consulta de forma directa conmigo
                                o, mejor aun, apuntate al taller online
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            >
                                <div class="overview-title pb-4">
                                    ...
                                    <p>
                                        las consultas podran ser online,
                                        telefonicas o presenciales, por lo que
                                        no es necesario que vivas cerca de mi o
                                        te desplaces. por supuesto la magia de
                                        estar juntos se rompe un poco en la
                                        distancia, pero he trabajado muchas
                                        veces asi y te aseguro que sera muy
                                        eficaz <br />
                                        <br />
                                        siempre estoy flexibilizandome y
                                        adaptandome a las circunstancias mias y
                                        de la otra persona, por lo que no
                                        descarto nada, asi que ponte en contacto
                                        conmigo y buscaremos juntos cual es la
                                        mejor formula para ambos. por ponerte un
                                        ejemplo, en ocasiones he trabajado cinco
                                        dias seguidos con personas que
                                        necesitaban un empujon grande, y han
                                        estado o en mi casa o en un apartamento
                                        por la zona donde vivo. quien quiere,
                                        siempre encuentra como!
                                        <img
        ...
        <section
            class="conference bg-company mt-6"
                    ...
                    <div class="row gx-lg-5 align-items-center">
                        <div class="col-lg-6 order-2 order-lg-1">
                            <div
                                ...
                                style="
                                    background-image: url('images/others/cambio-transformacion.png') !important;
                                "
                            >
                                <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2">
                            <div class="event-benifit-list-right text-lg-start">
                                ...
                                <div class="overview-info">
                                    <P class="text-white"
                                        >te dejo varios informes reales, en
                                        donde he cambiado el nombre de la
                                        persona para mayor privacidad, con el
                                        fin de que sepas que puedes esperar de
                                        una consulta individual conmigo</P
                                    >
                                </div>
                            </div>
                        </div>
