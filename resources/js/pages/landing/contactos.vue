                ...
                <div class="contact-inner text-center text-md-start">
                    <div class="row">
                        <div class="col-lg-5 col-md-5 text-center">
                            <img :src="`${$page.props.public_path}images/team/maria-contacto.png`" class="w-100" style="
                                    margin-top: -60px;
                                    margin-left: -50px;
                                    margin-bottom: -40px;
                                " />
                                    ...
                                    <form id="form-contact" @submit.prevent="onSubmit">
                                        ...
                                        <div class="message">
                                            ...
                                            <textarea v-model="form.message" placeholder="mensaje" name="message"
                                                class="mb-3" rows="5" style="resize: none" required></textarea>
                                            <img :src="`${$page.props.public_path}images/icon/aster.png`" style="
                                                    width: 8px;
                                                    margin-top: -130px;
                                                    margin-left: 82px;
                                                    ...
                                                    opacity: 0.6;
                                                " v-if="!form.message" />
                                            <label id="tooltip-attachments" href="javascript:;" data-bs-toggle="tooltip"
                                                data-bs-placement="right" title="añadir adjuntos" for="attachments"
                                                style="
                                                    float: right;
                                                    margin-top: -60px;
                                                    contain: content;
                                            ...
                                            <input @input="
                                                form.attachments =
                                                $event.target.files
                                                " type="file" multiple style="display: none" id="attachments" />
                                        ...
                                        <div class="radio mt-0 mb-2 radio-not-found" style="
                                                text-align: left;
                                                cursor: pointer;
                                            ">
                                            <i class="fa text-white" :class="contactPrivateArea
                                                ? 'fa-circle'
                                                : 'fa-circle-o'
                                                " style="
                                                    font-size: 18px;
                                                ...
                                                " @click="
                                                    ...
                                                    !contactPrivateArea
                                                    "></i>
                                            <label class="text-white" style="cursor: pointer" @click="
                                                contactPrivateArea =
                                                !contactPrivateArea
                                            ...
                                            <a class="popover" tabindex="0" role="button" data-bs-toggle="popover"
                                                ...
                                                style="
                                                    ...
                                                    border: none;
                                                "><img :src="`${$page.props.public_path}images/icon/info.png`" /></a>
                                        </div>
                                        <div class="pedido" style="text-align: left" v-if="contactPrivateArea">
                                            <input v-model="form.book_number" type="text" name="book_number"
                                            ...
                                            <input v-model="form.book_date" :type="book_date" name="book_date"
                                                placeholder="fecha de compra del libro" required class="mb-3"
                                                @focus="onFocusDate" @blur="onBlurDate" />
                                            <img :src="`${$page.props.public_path}images/icon/aster.png`" style="
                                                    width: 8px;
                                                    margin-top: -40px;
                                                    margin-left: 211px;
                                        ...
                                        <div class="radio mt-0 mb-2 radio-not-found" style="text-align: left"
                                            @click="iAmNot = !iAmNot">
                                            <i class="fa text-white" :class="iAmNot
                                                ? 'fa-circle'
                                                : 'fa-circle-o'
                                                " style="
                                                    font-size: 18px;
                                                    cursor: pointer;
                                                "></i>
                                            <label for="radio" class="text-white" style="cursor: pointer">&nbsp;la
                                                persona que aparece en
                                                el ticket no soy yo</label>
                                        </div>
                                        <div v-if="iAmNot">
                                            <input v-model="form.other_people" type="text" name="other_people"
                                                placeholder="nombre de la persona que aparece en el pedido" class="mb-3"
                                                required />
                                            <img :src="`${$page.props.public_path}images/icon/aster.png`" style="
                                                    width: 8px;
                                                    margin-top: -40px;
                                        ...
                                        <button class="btn" type="submit" :disabled="sending">
                                            enviar<i class="fa fa-long-arrow-right ms-3"></i>
                                        </button>
                                    </form>
                                </div>
                            </div>
