<template>
    <Layout>
                            ...
                            >
                                <div class="overview-title pt-8">
                                    ...
                                    >
                                        ...
                                        desprogramarte y liberar, a sanar<br />y
                                        conseguir como yo vivir en plenitud?<br /><br />o,
                                        eres terapeuta y<br />deseas convertirte
                                        en facilitador de procesos personales?
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 m-auto">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <P
                                        >se trata de un programa online de 3
                                        meses en donde semanalmente tendremos
                                        dos reuniones para practicar en grupo
                                        los recursos que he propuesto en el
                                        libro. iras haciendo los ejercicios a tu
                                        ritmo personal en casa, pero en grupo
                                        los revisaremos y solucionaremos dudas,
                                        practicaremos y compartiremos con los
                                        demas nuestro propio camino</P
                                    >
                                    <p>
                                        adicionalmente, a lo largo del mes,
                                        tendre una consulta individual contigo,
                                        en donde te conocere profundamente para
                                        poder apoyarte y guiarte en tu camino
                                        hacia tu plenitud, para ello utilizare
                                        recursos de liberacion emocional,
                                        desprogramacion de creencias y reflexion
                                        y al finalizarla te escribire un informe
                                        personal sobre lo que hemos trabajado y
                                        mis recomendaciones y reflexiones sobre
                                        tu personalidad y circunstancias
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section
            class="conference py-6 my-6 bg-company"
                    ...
                    <div class="row gx-lg-5 align-items-center">
                        <div class="col-lg-6 order-2 order-lg-1">
                            <div
                                ...
                                style="
                                    background-image: url('images/others/sbye-desarrollo.png') !important;
                                "
                            >
                                <div class="row align-items-center">
                                    <div class="col-lg-6 col-md-6 px-2 pt-2">
                                        <div
                                            class="event-benifit-list-left mb-4"
                                        >
                                            <div
                                                class="py-2 px-4 rounded mb-4 box-shadow bg-white"
                        ...
                        <div class="col-lg-6 order-1 order-lg-2">
                            <div class="event-benifit-list-right text-lg-start">
                                <div class="overview-info">
                                    <p class="text-white">
                                        te dejo varios informes reales, en donde
                                        he cambiado el nombre de la persona para
                                        mayor privacidad, con el fin de que
                                        sepas que puedes esperar de una consulta
                                        individual conmigo dentro del taller
                                        online
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            >
                                <div class="overview-title px-4">
                                    <h4 class="mb-2">
                                        QUIERES CONVERTIRTE EN FACILITADOR DE
                                        PROCESOS PERSONALES?
                                    </h4>
                                    <P
                                        >haz el taller online de 3 meses y
                                        practica de forma directa conmigo
                                        primero a traves del taller y
                                        posteriormente tendremos una consulta
                                        individual mensual hasta que sintamos
                                        que estas totalmente empoderado para
                                        poder ayudar a otras personas desde tu
                                        propia experiencia personal y con total
                                        dominio de los recursos que he propuesto
                                        en el libro y otros que te ire
                                        proponiendo en caso de que sean
                                        necesarios en tu interaccion personal
                                        con otras personas</P
                                    >
                                    <p>
                                        al finalizar contaras con mi apoyo
                                        incondicional para ayudarte a resolver
                                        tus dudas cuando estes trabajando hacia
                                        los demas, ademas de mi apoyo en tu
                                        propio proceso personal, como cualquier
                                        otro cliente-amigo
                                    </p>
                                    <p>
                                        por supuesto, aunque ya sabes que no se
                                        trata de una formacion oficial, contaras
                                        con tu titulo de facilitador de prosesos
                                        personales firmado por mi
                                        <img
