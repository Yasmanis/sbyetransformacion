            ...
            <div class="contact-form">
              ...
              <div class="form">
                <form id="form-contact">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <input type="text" name="name" placeholder="nombre" required class="mb-3">
                    ...
                    <div class="col-lg-6 ">
                      <input type="text" name="surname" placeholder="apellidos" required class="mb-3">
                  ...
                  <div class="subject">
                    <input type="text" name="email" placeholder="email" required class="mb-3">
                  ...
                  <div class="pedido" style="text-align: left; display: none;">
                    <input type="text" name="book_number" placeholder="numero de pedido de amazon por la compra del libro" class="mb-3" required>
                    ...
                    <input type="date" name="book_date" placeholder="fecha de compra del libro" required class="mb-3">
                  ...
                  <div class="message" id="message" style="display: none;">
                    <input type="text" name="register" placeholder="registro y alta en area privada" class="mb-3">
                    <textarea placeholder="mensaje" name="message" rows="4" class="mb-3" rows="5" style="resize: none;"></textarea>
                    ...
                    <input type="file" multiple style="display: none;" id="attachments">
                  </div>
                  <a class="btn" id="send-contact">enviar<i class="fa fa-long-arrow-right ms-3"></i></a>
                </form>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
      ...
      $('#send-contact').on('click', function(ev){
        	ev.preventDefault();
